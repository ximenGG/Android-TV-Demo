...
import com.iptv.anim.FragmentAnimator;
...
public class SupportActivity extends AppCompatActivity implements ISupportActivity {
    ...
    public boolean dispatchKeyEvent(KeyEvent event) {
        if (getTopFragment() != null)
            return getTopFragment().dispatchKeyEvent(event) || super.dispatchKeyEvent(event);
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (getTopFragment() != null)
            return getTopFragment().onKeyDown(keyCode, event) || super.onKeyDown(keyCode, event);
        return super.onKeyDown(keyCode, event);
    }

    public void showStackHierarchyView() {
        mDelegate.showFragmentStackHierarchyView();
    }
}
