...
import com.iptv.hq.ui.views.indicators.BallPulseIndicator;
import com.iptv.hq.ui.views.indicators.Indicator;
import com.iptv.hq.ui.views.indicators.IndicatorHelper;
...
public class LoadingView extends View {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        int indicatorName = a.getInt(R.styleable.LoadingView_indicatorName, 0);
    ...
    public void setIndicator(int indicator) {
        setIndicator(IndicatorHelper.createIndicator(indicator));
    }
